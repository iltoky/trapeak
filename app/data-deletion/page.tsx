...
export default function Deletion() {
  return <LegalPage eyebrow="LEGAL / 03" title="Data Deletion">
    <p>You can request deletion of your TRAPEAK account, imported fitness profile, stored workouts, connected-provider records, and support information associated with you.</p>
