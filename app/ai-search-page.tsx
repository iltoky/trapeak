  ...
  return (
    <main className="guide-page">
      ...
      <header className="nav shell">
        <Link className="wordmark" href="/" aria-label="TRAPEAK home"><Braces small /> TRAPEAK</Link>
      ...
      <section className="guide-hero shell">
        <p className="guide-breadcrumb"><Link href="/">TRAPEAK</Link><span>/</span>{eyebrow}</p>
      ...
      <section className="guide-prompts shell">
        ...
        <div className="prompt-list">
          ...
          <small>Illustrative examples only. Answers would be generated by the AI client, not by TRAPEAK.</small>
        </div>
      </section>
      ...
      <footer className="shell guide-footer">
        ...
        <div><b>GUIDES</b>{guides.map((guide) => <Link href={guide.href} key={guide.href}>{guide.label}</Link>)}</div>
