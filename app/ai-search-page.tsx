...
const guides = [
  { href: "/wahoo-to-chatgpt", label: "Wahoo to ChatGPT" },
  { href: "/wahoo-to-claude", label: "Wahoo to Claude" },
  { href: "/wahoo-mcp", label: "Wahoo MCP" },
    ...
    <main className="guide-page">
      ...
      <section className="guide-hero shell">
        ...
        <div className="guide-hero-bottom">
          <p>{intro}</p>
          <div className="guide-status"><b>PRODUCT STATUS</b><span>{statusLabel}</span><p>{status}</p></div>
        </div>
      </section>
      ...
      <section className="guide-prompts shell">
        ...
        <div className="prompt-list">
          ...
          <small>Illustrative examples only. AI responses would be generated by the connected assistant using authorized data made available through TRAPEAK. {sourceNote}</small>
        </div>
      </section>
