...
export const metadata: Metadata = {
  title: "AI guides",
  description: "Practical guides to the TRAPEAK private-beta connection between authorized fitness and health data and MCP-compatible AI assistants.",
...
const guides = [
  ...
  { href: "/wahoo-mcp", label: "Wahoo MCP", description: "The production private-beta MCP layer for Wahoo, Nutrition, and Labs." },
  ...
  return (
    <main className="guides-index">
      ...
      <section className="guides-index-hero shell">
        ...
        <h1>AI guides.</h1>
        <p>Clear explanations of how TRAPEAK connects user-authorized fitness and health records with MCP-compatible AI assistants. Wahoo is live in private beta; Garmin remains planned pending API approval.</p>
      </section>
      ...
      <footer className="shell guide-footer">
        ...
        <p className="copyright">© 2026 TRAPEAK. Private beta. Third-party names and trademarks are used descriptively and do not imply endorsement or partnership.</p>
      </footer>
    </main>
  );
}
