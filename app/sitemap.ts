...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/garmin-to-chatgpt`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/garmin-to-claude`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/garmin-mcp`, lastModified, changeFrequency: "monthly", priority: 0.7 },
