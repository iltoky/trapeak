...
export default function Privacy() {
  return <LegalPage eyebrow="LEGAL / 01" title="Privacy Policy">
    ...
    <h2>1. Information we collect</h2><p>We collect account details and identifiers, security and usage information, connected-client details, and fitness profile and workout data that you explicitly authorize us to import. We also receive information you choose to send to support.</p>
