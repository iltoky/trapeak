...
export const metadata: Metadata = {
  ...
  description: "TRAPEAK's roadmap for one secure MCP connection across wearable data sources. Wahoo is live in private beta, while Garmin and other sources remain planned.",
...
export default function WearableMcpPage() {
  return <AiSearchPage
    ...
    intro="TRAPEAK's long-term direction is a single, user-controlled MCP connection for fitness and health data from multiple sources. Wahoo is live for authenticated private-beta users."
    ...
    statusLabel="ROADMAP"
    status="Wahoo is live in private beta. Garmin is planned pending API approval, while Suunto remains under review. Other sources are roadmap candidates."
    steps={[
    ...
    dataPoints={["Wahoo — production private beta", "Garmin — planned; API access pending provider approval", "Suunto — API application under review", "Polar, Oura, Apple Health and Health Connect — later-stage candidates"]}
    ...
    sourceNote="Wahoo is live in private beta; all other source statuses are described on this page."
    faqs={[
      { question: "Which wearables does TRAPEAK support today?", answer: "Wahoo is available to authenticated private-beta users. Garmin is planned pending API approval, and Suunto remains under review." },
