...
- нормализованный provider-профиль и полные доступные метрики предыдущих тренировок;
...
- явные признаки отсутствующих данных: цели, ограничения, сон, HRV и recovery.
...
- golden prompt tests;
- пользовательский профиль с целями, расписанием, травмами и ограничениями;
