...
Статус: **Done in Preview** — реальное подключение подтверждено владельцем проекта 13 августа 2026 года.
...
- Добавить `WAHOO_CLIENT_ID`, `WAHOO_CLIENT_SECRET`, `APP_URL`, PostgreSQL URL (`DATABASE_URL` или Neon `POSTGRES_URL`) и `TOKEN_ENCRYPTION_KEY` в environment secrets.
